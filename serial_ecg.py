...
## Assignment 2 (1) Write a code that shows the R Peak in real time and also the Heart Rate on the graph.
...
class serialPlot:
    ...
    def getSerialData(self, frame, lines, lineValueText, lineLabel, timeText, ax, sp):
        ...
        ## HINT: Use np.array's copy() method to avoid threading-conflicting issue
